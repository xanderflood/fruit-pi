...
//TODO create a new error interface Wherer and a new
//NewError that creates an error which records your
//line location. Then modify Error and Errorf to
//check for Wherer's and display the location.
